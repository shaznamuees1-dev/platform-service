...
helm.sh/chart: {{ include "platform-chart.chart" . }}
...
*/}}
{{- define "platform-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "platform-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
